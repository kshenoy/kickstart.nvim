...

  {
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        vim.keymap.set('n', '<Plug>(leader-vcs-map)p', require('gitsigns').preview_hunk, { buffer = bufnr, desc = 'Preview hunk' })
...
-- Custom utility function to safely check if a module exists useful to conditionally setup plugins
...
if prequire('nvim-treesitter') then
  ...
  vim.defer_fn(function()
    ...
    require('custom.setup.treesitter').override()
  end, 0)
end
...
if require('custom.utils').is_neovim() then
  ...
  -- require('which-key').register {
    ...
    --   ['<leader>v'] = { name = '[V]CS', _ = 'which_key_ignore' },
