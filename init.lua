...
-- These are all stored in the lua/custom folder to keep it modular and distinct from kickstart's config
-- Note that the package manager (lazy.nvim) automatically loads all the plugins specified in custom/plugins
